    ...
    <div class="m-grid__item m-grid__item--fluid m-wrapper">
        ...
        <div class="m-content">
            <div class="m-portlet m-portlet--mobile">
                ...
                <form id="changePasswordForm" class="m-form m-form--fit m-form--label-align-right" method="post" action="{{route('admin.changePassword.edit',['id' => $user->id])}}">
                    {{csrf_field()}}
                        ...
                        <div class="row">
                            <div class="col-md-3"></div>
                                <div class="m-form__actions">
                                    ...
                                    <a href="{{route('admin.changePassword.index')}}" class="btn btn-secondary">Cancel</a>
                                </div>
                        </div>
