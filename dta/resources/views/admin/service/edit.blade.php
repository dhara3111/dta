                    ...
                    <ul class="m-subheader__breadcrumbs m-nav m-nav--inline">
                        ...
                        <li class="m-nav__item">
                            <a href="" class="m-nav__link">
                                <span class="m-nav__link-text">Update Service</span>
                            </a>
                        </li>
                    </ul>
                </div>
            ...
            <div class="row">
                <div class="col-md-12">
                    ...
                    <div class="m-portlet m-portlet--tab">
                        ...
                        <!--begin::Form-->
                        <form id="serviceEditForm" class="m-form m-form--fit m-form--label-align-right" method="post" action="{{route('admin.service.update',['id' => $service->id,'userId'=>$userId,'module'=>$module])}}">
                            {{csrf_field()}}
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group m-form__group @if ($errors->has('name')) has-danger @endif">
                                            ...
                                            <input type="text" name="name" class="form-control m-input" id="exampleInputEmail1" value="{{ $service->name }}" placeholder="Enter Service Name" >
                                            @if ($errors->has('name'))
