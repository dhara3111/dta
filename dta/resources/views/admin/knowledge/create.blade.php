                ...
                <div class="mr-auto">
                    ...
                    <ul class="m-subheader__breadcrumbs m-nav m-nav--inline">
                        ...
                        <li class="m-nav__item">
                            ...
                            <span class="m-nav__link-text">Add Knowledge</span>
                            </a>
                        </li>
                    </ul>
                </div>
            ...
            <div class="row">
                <div class="col-md-12">
                    ...
                    <div class="m-portlet m-portlet--tab">
                        ...
                        <!--begin::Form-->
                        <form id="knowledgeForm" enctype="multipart/form-data" class="m-form m-form--fit m-form--label-align-right" method="post" action="{{route('admin.knowledge.store',['userId' => $userId, 'module' => $module])}}">
                            {{csrf_field()}}
                            <div class="m-portlet__body">
                                <div class="row">
                                    <div class="col-md-12">
                                        <div class="form-group m-form__group">
                                            <label for="exampleInputEmail1 @if ($errors->has('name')) has-danger @endif">Name</label>
                                            <input type="text" name="topic_name" class="form-control m-input" id="topic_name" value="{{old('topic_name')}}" placeholder="Enter Topic Name" >
                                    ...
                                    <div class="col-md-12">
                                        <div class="form-group m-form__group">
                                            <label for="exampleInputEmail1 @if ($errors->has('description')) has-danger @endif">Description</label>
                                            <textarea  name="description" class="form-control m-input ckeditor" id="description" placeholder="Enter Knowledge Description">{{old('description')}}</textarea>
