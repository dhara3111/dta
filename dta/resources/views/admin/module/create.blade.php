            ...
            <div class="row">
                <div class="col-md-12">
                    ...
                    <div class="m-portlet m-portlet--tab">
                        ...
                        <!--begin::Form-->
                        <form id="moduleForm" class="m-form m-form--fit m-form--label-align-right" method="post" action="{{route('admin.module.store')}}">
                            {{csrf_field()}}
                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="form-group m-form__group @if ($errors->has('folder_name')) has-danger @endif">
                                            ...
                                            <input type="text" name="folder_name" class="form-control m-input" id="exampleInputEmail1" value="{{old('folder_name')}}" placeholder="Enter Folder Name" >
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group m-form__group @if ($errors->has('file_name')) has-danger @endif">
                                            ...
                                            <input type="text" name="file_name" class="form-control m-input" id="exampleInputEmail1" value="{{old('file_name')}}" placeholder="Enter File Name" >
                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="form-group m-form__group @if ($errors->has('title_name')) has-danger @endif">
                                            ...
                                            <input type="text" name="title_name" class="form-control m-input" id="exampleInputEmail1" value="{{old('title_name')}}" placeholder="Enter Title" >
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group m-form__group @if ($errors->has('icon')) has-danger @endif">
                                            ...
                                            <input type="text" name="icon" class="form-control m-input" id="exampleInputEmail1" value="{{old('icon')}}" placeholder="Enter Fa-Fa Icon" >
                                            @if ($errors->has('icon'))
