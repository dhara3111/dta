                    ...
                    <ul class="m-subheader__breadcrumbs m-nav m-nav--inline">
                        ...
                        <li class="m-nav__item">
                            <a href="" class="m-nav__link">
                                <span class="m-nav__link-text">Update Sub Admin</span>
                            </a>
                        </li>
                    </ul>
                </div>
            ...
            <div class="row">
                <div class="col-md-12">
                    ...
                    <div class="m-portlet m-portlet--tab">
                        ...
                        <!--begin::Form-->
                        <form id="subAdminFormEdit" class="m-form m-form--fit m-form--label-align-right" method="post" action="{{route('admin.adminUser.update',['id' => $user->id,'userId'=>$userId,'module'=>$module])}}">
                            {{csrf_field()}}
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group1 m-form__group @if ($errors->has('email')) has-danger @endif">
                                            ...
                                            <input type="text" name="email" class="form-control m-input" id="emai;" value="{{ $user->email }}" placeholder="Enter Email Address" style="cursor: not-allowed;" readonly>
                                            @if ($errors->has('email'))
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group m-form__group">
                                            <label for="exampleInputEmail1"><strong>Module Name</strong></label>
                                        </div>
                                    </div>
                                    <div class="col-md-6 row" style="text-align: center">
                                        <div class="col-md-3" >
                                            <div class="form-group1 m-form__group">
                                                <label for="exampleInputEmail1"><strong>View</strong></label>
                                            </div>
                                        </div>
                                        <div class="col-md-3" >
                                            <div class="form-group1 m-form__group">
                                                <label for="exampleInputEmail1"><strong>Add</strong></label>
                                            </div>
                                        </div>
                                        <div class="col-md-3">
                                            <div class="form-group1 m-form__group">
                                                <label for="exampleInputEmail1"><strong>Edit</strong></label>
                                            </div>
                                        </div>
                                        <div class="col-md-3" >
                                            <div class="form-group1 m-form__group">
                                                <label for="exampleInputEmail1"><strong>Delete</strong></label>
                                            </div>
                                        </div>
                                    </div>
                                </div>
...
//                                dd($permissions);
                                ...
                                @foreach($modules as $index => $module)
                                    ...
                                    @else
                                        <div class="row" >
                                            <div class="col-md-2">
                                                <div class="form-group1 m-form__group" style="text-align: center">
                                                ...
                                                @if($permission->module_id == $module->id )
                                                    ...
                                                    <div class="col-md-6 row" style="text-align: center" >
                                                        ...
                                                        <div class="col-md-3">
                                                            <div class="form-group1 m-form__group">
                                                                <label class="m-checkbox m-checkbox--check-bold m-checkbox--state-primary">
                                                                    <input type="hidden" name="permission[{{ $permission->module_id }}][add]" value="0" >
                                                                    <input type="checkbox" class="checkboxAll{{ $module->id }}" id="checkBoxAdd" name="permission[{{ $permission->module_id }}][add]"  value="{{ $permission->add ? '0' : '1'}}" {{ $permission->add ? ' checked' : '' }}>
                                                                    <span></span>
                                                                </label>
                                                            </div>
                                                        </div>
                                                        <div class="col-md-3">
                                                            <div class="form-group1 m-form__group">
                                                                <label class="m-checkbox m-checkbox--check-bold m-checkbox--state-primary">
                                                                    <input type="hidden" name="permission[{{ $permission->module_id }}][edit]" value="0" >
                                                                    <input type="checkbox" class="checkboxAll{{ $module->id }}" id="checkBoxEdit" name="permission[{{ $permission->module_id }}][edit]"  value="{{ $permission->edit ? '0' : '1'}}" {{ $permission->edit ? ' checked' : '' }}>
                                                                    <span></span>
                                                                </label>
                                                            </div>
                                                        </div>
                                                        <div class="col-md-3">
                                                            <div class="form-group1 m-form__group">
                                                                <label class="m-checkbox m-checkbox--check-bold m-checkbox--state-primary">
                                                                    <input type="hidden" name="permission[{{ $permission->module_id }}][delete]" value="0">
                                                                    <input type="checkbox" class="checkboxAll{{ $module->id }}" id="checkBoxDelete" name="permission[{{ $permission->module_id }}][delete]"  value="{{ $permission->delete ? '0' : '1'}}" {{ $permission->delete ? ' checked' : '' }}>
                                                                    <span></span>
                                                                </label>
                                                            </div>
                                                        </div>
                                            ...
                                            <div class="col-md-6 row" >
                                                <div class="col-md-3">
                                                    <div class="form-group1 m-form__group">
                                                        {{--{{ (is_array(old('where_find')) && in_array($whereFind->id, old('where_find'))) ? ' checked' : '' }}--}}
                                                        <label class="m-checkbox m-checkbox--check-bold m-checkbox--state-primary">
                                                            <input type="checkbox" name="permission[{{ $module->id }}][view]" value="1">
                                                            <span></span>
                                                        </label>
                                                    </div>
                                                </div>
                                                <div class="col-md-3">
                                                    <div class="form-group1 m-form__group">
                                                        <label class="m-checkbox m-checkbox--check-bold m-checkbox--state-primary">
                                                            <input type="checkbox" name="permission[{{ $module->id }}][add]" value="1">
                                                            <span></span>
                                                        </label>
                                                    </div>
                                                </div>
                                                <div class="col-md-3">
                                                    <div class="form-group1 m-form__group">
                                                        <label class="m-checkbox m-checkbox--check-bold m-checkbox--state-primary">
                                                            <input type="checkbox" name="permission[{{ $module->id }}][edit]" value="1">
                                                            <span></span>
                                                        </label>
                                                    </div>
                                                </div>
                                                <div class="col-md-3">
                                                    <div class="form-group1 m-form__group">
                                                        <label class="m-checkbox m-checkbox--check-bold m-checkbox--state-primary">
                                                            <input type="checkbox" name="permission[{{ $module->id }}][delete]" value="1">
                                                            <span></span>
                                                        </label>
                                                    </div>
                                                </div>
