        ...
        <!--end::Head-->
            ...
            <div class="m-login__body">
                ...
                <div class="m-login__signin">
                    ...
                    <!--begin::Form-->
                    <form id="resetPasswordForm" class="m-login__form m-form" method="GET" action="{{route('advertiser.resetPassword.reset',['key'=>$key,'id'=>$id])}}">
                        @csrf
                        ...
                        <div class="m-login__action">
                            ...
                            {{--</a>--}}
                            <a href="{{ route('advertiser.login.index') }}" id="" class="m-link" style="color: #4c4c4c;">< Back To Login</a>
                            {{--<a href="#">--}}
