...
<head>
    <title>Register | {{$otherDetail->website_name}} </title>
...
<section class="tz-login">
    <div class="tz-regi-form">
        ...
        <form id="register" class="col s12" action="{{ route('frontend.register.store') }}" method="post">
            {{ csrf_field() }}
            <div class="row">
        ...
        <p>Are you a already member ? <a href="{{route('frontend.login.index')}}">Login</a> </p>
    </div>
</section>
...
<section class="copy">
    <div class="container">
        <p>© 2019 <lable style="#da2129;">{{$otherDetail->website_name}}</lable>.</p>
    </div>
</section>
