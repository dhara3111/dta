        ...
        <div class="log-in-pop-right">
            ...
            <form id="forgotPassword" class="s12" action="{{ route('frontend.forgetPassword.send') }}" method="post">
                ...
                <div class="checkbox pull-right">
                    <span class="link-not-important ">Are you a already member ?</span><a href="{{ route('frontend.login.index') }}" class="link-not-important " style="color:#da2129"> Login </a>
                    <br>
                </div>
                <div>
...
<section class="copy">
    <div class="container">
        <p>© 2019 <lable style="color:#ff4702;">{{$otherDetail->website_name}}</lable>.</p>
    </div>
</section>
