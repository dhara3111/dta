...
<section class="tz-register">
    <div class="log-in-pop">
        ...
        <div class="log-in-pop-right">
            ...
            <form id="login" class="s12" action="{{ route('frontend.login.doLogin') }}" method="post">
                {{ csrf_field() }}
                ...
                <div class="checkbox">
                    <a href="{{ route('frontend.forgetPassword.index') }}" class="link-not-important pull-right">Forgot Password ?</a>
                    <br>
                </div>
                <div>
