var Inputmask = {
    init: function () {
        $("#m_inputmask_1").inputmask("mm/dd/yyyy", {autoUnmask: !0}), $("#m_inputmask_2").inputmask("mm/dd/yyyy", {placeholder: "*"}), $("#m_inputmask_3").inputmask("mask", {mask: "(999) 999-9999"}),$(".inputMask").inputmask("mask", {mask: "(999) 999-9999"}),$(".ein").inputmask("mask", {mask: "99-9999999"}), $("#m_inputmask_4").inputmask({
            mask: "99-9999999",
            placeholder: ""
