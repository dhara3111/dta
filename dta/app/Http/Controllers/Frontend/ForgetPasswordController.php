...
class ForgetPasswordController extends Controller
{
    ...
    public function send(Request $request)
    {
        ...
        if ($userCheck) {
            ...
            $user  = User::whereEmail($email)->whereType('3')->first();
            ...
            $resetPasswordLink = route('frontend.resetPassword.index',['key'=>encrypt($token),'id'=>$user->id]);
...
//                $mail->addAddress('anant@dwarkeshit.com');               // Name is optional
            ...
            return redirect(route('frontend.forgetPassword.index'))->with(['success' => 'Email sent successfully']);
        }
        else{
            return redirect(route('frontend.forgetPassword.index'))->with(['error' => 'This email id is not registered on EOI 360']);
        }
    }
}
