...
//            {
            return view('advertiser.resetPassword.index',[
                'key' => $key,
                'id' => $id,
            ]);
//            }
...
//                return redirect(route('advertiser.forget.index'))->with('error','This link is no longer available');
//            }
...
//            $user->password = Hash::make($request->password);
            ...
            $user->save();
            return redirect(route('advertiser.login.index'))->with('success','New password set successfully');
