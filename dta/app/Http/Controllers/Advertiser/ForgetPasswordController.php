...
class ForgetPasswordController extends Controller
{
    ...
    public function index(){
        return view('advertiser.forgetPassword.index');
    }
    ...
    public function send(Request $request)
    {
        ...
        if ($userCheck) {
            ...
            $resetPasswordLink = route('advertiser.resetPassword.index',['key'=>encrypt($token),'id'=>$user->id]);
...
//                $mail->addAddress('anant@dwarkeshit.com');               // Name is optional
            ...
            return redirect(route('advertiser.forgetPassword.index'))->with(['success' => 'Email sent successfully']);
        }
        else{
            return redirect(route('advertiser.forgetPassword.index'))->with(['error' => 'This email id is not registered on EOI 360']);
        }
    }
}
